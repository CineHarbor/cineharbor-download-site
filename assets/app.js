(function attachDownloadSite(globalObject, factory) {
  ...
  globalObject.CineHarborDownloadSite = api;
})(
  typeof window !== 'undefined' ? window : globalThis,
  function createApi(globalObject) {
    const LOCALE_STORAGE_KEY = 'cineharbor-download-site:locale';
    const THEME_STORAGE_KEY = 'cineharbor-download-site:theme';
    const SYSTEM_DARK_THEME_QUERY = '(prefers-color-scheme: dark)';
    const DATA_URL = './data/releases.json';

    const COPY = {
      'zh-CN': {
        eyebrow: 'CineHarbor 桌面下载站',
      ...
      en: {
        eyebrow: 'CineHarbor Desktop Download Site',
        heroTitle: 'Build Ledger',
        heroSubtitle:
    ...
    function createDownloadSiteApp(documentRef) {
      ...
      function render(payload) {
        state.payload = {
          ...
          repository: payload.repository || 'CineHarbor/cineharbor-desktop',
