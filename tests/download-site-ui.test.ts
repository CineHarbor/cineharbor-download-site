...
const downloadSiteAppModule =
  require('../assets/app.js') as DownloadSiteAppModule;
...
describe('download site app', () => {
      ...
      releases: [
        {
          ...
          version: '200.0.1',
          name: 'CineHarbor Desktop 200.0.1',
          prerelease: false,
          ...
          assets: [
            {
              fileName: 'CineHarbor.Desktop_200.0.1_windows-x64-setup.exe',
  ...
  it('follows dark system preference on first render and toggles theme persistently', () => {
    ...
    expect(window.localStorage.getItem('cineharbor-download-site:theme')).toBe(
      'light'
    );
  });
      ...
      releases: [
        {
          ...
          assets: [
            ...
            {
              fileName: 'CineHarbor.Desktop_200.0.1_macos-arm64.dmg',
              platformLabel: 'macOS Apple Silicon',
      ...
      releases: [
        {
          ...
          name: 'CineHarbor Desktop 200.0.1 Beta 38',
          prerelease: true,
          ...
          assets: [
            {
              fileName: 'CineHarbor.Desktop_200.0.1-beta.38_macos-arm64.dmg',
              platformLabel: 'macOS Apple Silicon',
              downloadUrl: 'https://example.com/apple.dmg',
              size: 100,
            },
            {
              fileName: 'CineHarbor.Desktop_200.0.1-beta.38_macos-x64.dmg',
